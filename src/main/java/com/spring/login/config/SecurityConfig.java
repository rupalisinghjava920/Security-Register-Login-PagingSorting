...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/", "/register","/signin", "/saveRegister","/student/addStudentRegister","/updateStudentRegister/{id}","/deleteStudentRegister/{id}","/page/{pageNo}","/search/filterByName").permitAll()
